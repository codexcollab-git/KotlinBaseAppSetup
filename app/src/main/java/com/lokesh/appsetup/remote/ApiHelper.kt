...
import com.lokesh.appsetup.ui.module.compose.MainActivity
import com.lokesh.appsetup.util.NetworkManager
import com.lokesh.appsetup.util.getStringResource
import com.lokesh.appsetup.util.showToast
import com.lokesh.appsetup.util.startActivityWithParams
        ...
        when (code) {
            ...
            401 -> {
                if (App.getCurrentActivity() != null) {
                    ...
                    App.getAppContext().showToast(getStringResource(R.string.activity_not_found))
                }
            }
                                ...
                                try {
                                    ...
                                    if (key.equals("error", ignoreCase = true)) {
                                        ...
                                        if (json is JSONObject) {
                                            ...
                                            while (iteratorInside.hasNext()) {
                                                val key2 = iteratorInside.next()
                                                if (key2.equals("message", ignoreCase = true) || key2.equals(
                                                        "field",
                                                        ignoreCase = true
                                                    )
                                                ) {
