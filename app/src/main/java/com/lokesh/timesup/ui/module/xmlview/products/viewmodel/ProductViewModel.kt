package com.lokesh.timesup.ui.module.xmlview.products.viewmodel
...
@HiltViewModel
class ProductViewModel @Inject constructor(app: Application, private val repo: ProductAPIRepository) : BaseViewModel(app) {
