...
import com.lokesh.timesup.base.ErrorBody
import com.lokesh.timesup.databinding.FragmentProductListBinding
import com.lokesh.timesup.model.Product
import com.lokesh.timesup.ui.module.xmlview.products.adapter.ProductsAdapter
import com.lokesh.timesup.ui.module.xmlview.products.model.GetProductsResponse
import com.lokesh.timesup.ui.module.xmlview.products.viewmodel.ProductViewModel
...
import com.lokesh.timesup.util.datastore.DataStoreKeys
import com.lokesh.timesup.util.globalLiveInternetCheck
import com.lokesh.timesup.util.onClick
import com.lokesh.timesup.util.prefs.PrefsKeys
...
class ProductListFragment : BaseFragment<FragmentProductListBinding>() {
    ...
    private fun callApi(){
        if (NetworkManager.internetAvailable){
            ...
            viewModel.getProductsByCategoryOffline(true, category)
    ...
    private fun backPress(){
        val bundle = Bundle()
        bundle.putString(BACK_CATEGORY_DATA, category)
