package com.lokesh.timesup.customdialog.util
...
import com.lokesh.timesup.commonlistener.ClickConfirmListener
import com.lokesh.timesup.commonlistener.ClickListener
import com.lokesh.timesup.customdialog.CustomDialog
...
fun Context.showLoaderDialog(
    ...
    return if (prevDialog != null && prevDialog.dialogInstance.getLoaderDialog()?.isShowing == true) prevDialog else {
...
fun Context.showPermissionRequired(
    ...
    if (prevDialog != null && prevDialog.dialogInstance.getDialog().isShowing) prevDialog.dialogInstance.getDialog()
        .cancel()
    val dialog = CustomDialogBuilder(this)
