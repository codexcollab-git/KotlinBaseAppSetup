package com.lokesh.timesup.customdialog
...
import com.lokesh.timesup.customdialog.adapter.DialogSelectOptionAdapter
import com.lokesh.timesup.R
import com.lokesh.timesup.base.OptionModel
import com.lokesh.timesup.commonlistener.ClickListener
import com.lokesh.timesup.customdialog.adapter.DialogOptionAdapter
import com.lokesh.timesup.databinding.CustomDialogLayoutBinding
import com.lokesh.timesup.databinding.CustomDialogProgressLoaderBinding
import com.lokesh.timesup.util.goneView
import com.lokesh.timesup.util.hideView
import com.lokesh.timesup.util.onClick
import com.lokesh.timesup.util.showView
...
class CustomDialog {
    ...
    constructor(
        ...
        if (heading == null || heading.isEmpty()) dialogBinding.heading.goneView() else setHeading(
            heading
        )
    ...
    constructor(
        ...
        if (confirmTextBg != null) dialogBinding.cancel.background =
    ...
    constructor(
        ...
        dialogBinding.ok.goneView()
        if (confirmTxt == null || confirmTxt.isEmpty()) dialogBinding.cancel.goneView() else setNegativeLabel(
            confirmTxt
        )
        if (showCloseButton) {
            dialogBinding.close.showView()
