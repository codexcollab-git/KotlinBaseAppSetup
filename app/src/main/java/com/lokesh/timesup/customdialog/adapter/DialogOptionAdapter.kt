package com.lokesh.timesup.customdialog.adapter
...
import com.lokesh.timesup.databinding.LayoutDialogOptionBinding
...
class DialogOptionAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        } else holder.binding.icon.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_radio_empty))
    }
